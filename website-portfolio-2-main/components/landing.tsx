...
export default function VideoCyclePlayer() {
    ...
    return (
        ...
        >
            ...
            {/* Video Section */}
            <div
                className="absolute left-1/2 top-1/2 style={{ md-top: '10px' }} transform -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl cursor-pointer transition duration-300"
                onClick={handleClick}
            >
                {!isLoaded && (
