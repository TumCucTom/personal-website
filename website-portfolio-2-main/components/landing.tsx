...
export default function VideoCyclePlayer() {
    ...
    return (
        ...
        >
            ...
            {/* Video Section */}
            <div
                className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-[50%] md:-translate-y-[75%] w-full max-w-3xl cursor-pointer transition duration-300"
                onClick={handleClick}
            >
                {!isLoaded && (
